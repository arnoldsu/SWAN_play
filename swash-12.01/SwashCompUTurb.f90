...
!   Purpose
!
!   Computes turbulence quantities by means of solving a 3D turbulence model on triangular mesh
!
!   Method
!
...
!   Source text
!
    if (ltrace) call strace (ient,'SwashCompUTurb')
    !
