...
!     version of initialisation file                                      10.16
      INIVER = 6                                                          10.01 1.10 40.41 40.31
      INIVEF = -1                                                         40.00
      INERR  = 0                                                          34.01
!
      IF (PARLL) THEN
...
!
      KPART = 1                                                            1.10
!     by default, merge the individual output files
      IMRGE = 1                                                           10.01
!
...
!UNIX          DIRCH2 = CHAR(47)                                               40.30
        ...
        IF (INIVEF.GT.5) READ (11, *,   ERR=930, END=930) IMRGE           10.01
        IF (INIVEF.GT.3) THEN
           IF (PARLL) THEN
              DO JJ = 1, NPROC
...
!
     ...
     &                ERR=950)
           ...
           WRITE (12, 210) IMRGE,  'option to merge output files'         10.01
           IF (PARLL) THEN
              DO II = 1, NPROC
